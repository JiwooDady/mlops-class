...
if __name__ == "__main__":
    ...
    X.assign(rent=y).to_csv(
        ...
        os.path.join(DATA_PATH, "storage", "house_rent_train_freatures.csv"),
        index=False,
    )
    ...
    experiment_name = "new_experiment_with_log2"
    mlflow.set_experiment(experiment_name=experiment_name)
    logger.info("Set an mlflow expreiment...")
    mlflow.set_tracking_uri("./mlruns")  # 없어도 기본값
    ...
    best_run = mlflow.get_run(best_run_df.at[0, "run_id"])  # 실행정보 가져오기
